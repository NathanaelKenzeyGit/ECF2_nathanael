 ...
 */
final class Version20260910094841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE photo_path photo_path VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE photo_path photo_path VARCHAR(255) NOT NULL');
    }
}
